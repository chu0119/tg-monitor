                ...
                getSortedConversations().map((conv) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <p className="font-medium truncate text-sm sm:text-base flex-1 min-w-0">{conv.title || "Unknown"}</p>
      ...
      >
        <div className="flex items-start justify-between mb-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <p className="font-semibold">{message.sender_username || "Unknown"}</p>
        ...
        <div className="space-y-4 max-h-[60vh] sm:max-h-none overflow-y-auto">
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div>
              ...
              <p className="text-sm sm:text-base font-medium">{message.sender_username || "Unknown"}</p>
              {message.sender_id && (
            ...
            <div>
              ...
              <p className="text-sm sm:text-base font-medium">{message.conversation_title || "Unknown"}</p>
            </div>
          </div>
